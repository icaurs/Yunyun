...
public class CommentRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentRvAdapter(Context context, List<Comment> list, BitmapUtils bitmapUtils, HttpUtils httpUtils) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case Community.TYPE_VIEW:
                view = layoutInflater.inflate(R.layout.recycler_comment_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (getItemViewType(position)) {
            case Community.TYPE_VIEW:
                ...
                viewHolderMain.tvName.setText(comment.getName());
                viewHolderMain.tvTime.setText(comment.getTime());
                viewHolderMain.tvDetail.setText(comment.getDetail());
                break;
            case Community.TYPE_FOOT:
